...
select models.* from models join brands on brands.brand_id = models.brand_id where brands.name = 'Pontiac';
...
select models.name, brands.name, headquarters from brands join models on brands.brand_id = models.brand_id where brands.name = 'Ford' and models.name = 'Mustang';
...
select count(*) from models join brands on brands.brand_id = models.brand_id where brands.name = 'Ford';
...
select models.year, models.name, model_id, awards.name from models left join awards on winner_id = model_id where models.year >= 1964;
...
select name, year from models where year = (select founded from brands where models.year = founded);