...
def reverse_list_in_place(items):
    ...
    ***********************************************************************
    HELP!
    I am not sure why this test has 2 more evaluations that are failing.
    It appears that there is an error in the doc test, because 
    reverse_list_in_place(orig) should be pulling from the variable above,
    but it is not and shows:
        Failed example:
            reverse_list_in_place(orig)
        Expected nothing
    ***********************************************************************
        ...
        if letter not in word:
            ...
            for each_letter in word:
                ...
                if letter == each_letter:
                    indices_of_letter.append(word_index)
