...
def say_hi(name):
    """Prints "Hi (name)" with (name) as argument
    """
...
def repeat_string(word, num):
    """Prints word x times, with x as num argument
    """
...
def print_sign(num):
    """Prints statement that tells how given number is relative to 0.
    """
...
def is_divisible_by_three(num):
    """Returns True if divisible by 3, else returns False.
    """
...
def num_spaces(sentence):
    """Finds # of spaces in sentence and returns them.
    """
...
def total_meal_price(price, tip = 0.15):
    """Calulates total price of meal.

    Uses given price and tip. Tip defaults to 15% if none given.
    """
...
def sign_and_parity(num):
    """Prints whether num is positive or negative, and even or odd.
    """
...
def write_letter(name, title, sender):
    """Calls full_title function and prints letter.
    """
    name_and_title = full_title(name, title)

    print "Dear "+ name_and_title + ", I think you are amazing! Sincerely, " + sender
